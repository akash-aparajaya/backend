/*
  ...
  - A unique constraint covering the columns `[environment_id,service_type_id,provider_id,mode,is_active]` on the table `environment_service_providers` will be added. If there are existing duplicate values, this will fail.
